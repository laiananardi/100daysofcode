...
para o contrário.
*/
//quando atribuir valor a uma variavel você tem que temrinar com ;
const isTruthy = function(p){
...
carro.obterMarcaModelo = function(){
    // return 'Esse carro é um' + carro.obterMarca() + ' ' + carro.obeterModelo() ; 
    return `Esse carro é um ${carro.obterMarca()} ${carro.obeterModelo()}` ;
};
